...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    {
        Node* pNodo=(Node*)malloc(sizeof(Node));
        Node* pAuxNodo;
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if (this!=NULL && index>= 0 && this->size > index)
    {
        ...
        {
            pAuxAnteriorNodo = getNode(this,index-1);

            pAuxNodo = pAuxAnteriorNodo->pNextNode;

            pAuxAnteriorNodo->pNextNode = pAuxNodo->pNextNode;
...
void* ll_pop(LinkedList* this,int index)
{
    ...
    if (this!=NULL && index>=0 && index<=this->size-1)
    {
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if (this!=NULL && this2!=NULL)
    {
        ...
        for (int i = 0; i < this->size; i++)
        {
            pElementThis= ll_get(this2,i);

            answer = ll_contains(this,pElementThis);
    ...
    if(this!=NULL && pFunc !=NULL && (order == 0 || order == 1))
    {
        while (flagOrdenada)
        {
            ...
            for (int i = 0; i < ll_len(this)-1; i++)
            {
                ...
                answer= pFunc(pAux1,pAux2);

                if ((order == 1 && answer ==1) || (order == 0 && answer ==-1))
                {
                    ll_set(this,i, pAux2);
